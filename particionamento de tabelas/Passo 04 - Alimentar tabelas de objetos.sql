...
begin
	...
	SELECT @STRAUXILIAR=A.NOMEFILEGROUP, @STRFUNCAO=A.FUNCAOPARTICAO FROM tabelasistema A WHERE A.NOMETABELA=@TableName
...
begin
	...
	SET @STRFUNCAO = NULL
	SELECT @STRFUNCAO=A.FUNCAOPARTICAO FROM tabelasistema A WHERE A.NOMETABELA=@ParentTableName
...
BEGIN
	...
	SET @STRAUXILIAR=NULL
	SET @STRFUNCAO = NULL
	SELECT @STRAUXILIAR=A.NOMEFILEGROUP, @strfuncao=A.FUNCAOPARTICAO FROM tabelasistema A WHERE A.NOMETABELA=@NOMETABELA
