...
and t.NAME IN ('PONTO', 'ALOCACAOMAODEOBRA', 'VAGAITEMCONTRATO', 'POSTOLOCALSERVICO', 'LOCALSERVICOEMP', 'LIGAVGITEMCONTRATO','RELACAOENTIDADE','ENTIDADE','VAGAITEMCONTRATO',
'ITENSCONTRATO', 'ITENSCONTRLOCAL')
